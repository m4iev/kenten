...
echo "  <form action='../../php/submit_animasi.php' method='post' enctype='multipart/form-data'>";
...
echo "      <input type='url' id='script' name='script' placeholder='Link Script (pdf)' required>";
